$(document).ready(function () {
    ...
    $(document).on("click", "button[name='action_btn']", function (e) {
        ...
        if (valid) {
            ...
            if (isproses == 0) {
                ...
                $.ajax({
                    url: baseURL + 'spk/master/save/divisi',
                    type: 'POST',
                    dataType: 'JSON',
                    data: formData,
                    contentType: false,
    ...
    $(document).on('click', '.edit', function (e) {
        ...
        $.ajax({
            url: baseURL + 'spk/master/get/divisi',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function (data) {
                ...
                if (data.data) {
                    ...
                    $('input[name="id_divisi"]').val(id);
                    $('#nama_divisi').val(dataEdit.nama_divisi);
        ...
        kiranaConfirm(
            {
                ...
                successCallback: function () {
                    $.ajax({
                        url: baseURL + 'spk/master/delete/divisi',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
        ...
        kiranaConfirm(
            {
                ...
                successCallback: function () {
                    $.ajax({
                        url: baseURL + 'spk/master/set/divisi',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id,
