$(document).ready(function () {
    ...
    $(document).on("click", "button[name='action_btn']", function (e) {
        ...
        if (valid) {
            ...
            if (isproses == 0) {
                ...
                $.ajax({
                    url: baseURL + 'spk/master/save/jenisvendor',
                    type: 'POST',
                    dataType: 'JSON',
                    data: formData,
                    contentType: false,
    ...
    $(document).on('click', '.edit', function (e) {
        ...
        $.ajax({
            url: baseURL + 'spk/master/get/jenisvendor',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function (data) {
                ...
                if (data.data) {
                    ...
                    $('input[name="id_jenis_vendor"]').val(id);
                    $('#jenis_vendor').val(dataEdit.jenis_vendor);
        ...
        kiranaConfirm(
            {
                ...
                successCallback: function () {
                    $.ajax({
                        url: baseURL + 'spk/master/delete/jenisvendor',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
        ...
        kiranaConfirm(
            {
                ...
                successCallback: function () {
                    $.ajax({
                        url: baseURL + 'spk/master/set/jenisvendor',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id,
