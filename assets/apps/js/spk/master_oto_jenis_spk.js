$(document).ready(function () {
    ...
    $(document).on("click", "button[name='action_btn']", function (e) {
        ...
        if (valid) {
            ...
            if (isproses == 0) {
                ...
                $.ajax({
                    url: baseURL + 'spk/master/save/otojenisspk',
                    type: 'POST',
                    dataType: 'JSON',
                    data: formData,
                    contentType: false,
    ...
    $(document).on('click', '.edit', function (e) {
        ...
        $.ajax({
            url: baseURL + 'spk/master/get/otojenisspk',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function (data) {
                ...
                if (data.data) {
                    ...
                    $('input[name="id_oto_jenis"]').val(id);
                    $('#nama_dokumen').val(dataEdit.nama_dokumen);
                    $('#gambar_old').val(dataEdit.files);
        ...
        kiranaConfirm(
            {
                ...
                successCallback: function () {
                    $.ajax({
                        url: baseURL + 'spk/master/delete/otojenisspk',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
