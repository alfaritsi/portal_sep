                            ...
                            <div class="tab-pane active" id="tab-edit">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="tanggal_bak">Nama Jenis SPK</label>
                                        <div>
                                            <input type="text" class="form-control" name="jenis_spk"
                                                   id="jenis_spk"
...
<script src="<?php echo base_url() ?>assets/apps/js/spk/master_jenis_spk.js"></script>
