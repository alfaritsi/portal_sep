                    ...
                    <div class="box-body">
                        <table class="table my-datatable-extends-order table-bordered" id="menus-table" data-page-length="10"
                            ...
                            <tr>
                                ...
                                <th data-orderable="false" data-searchable="false" width="20"></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            foreach ($list as $dt) {
                                ...
                                echo "<li><a href='#' class='edit' data-edit='" . $dt->id_divisi . "'><i class='fa fa-pencil-square-o'></i> Edit</a></li>";
                                if ($dt->na == 'n') {
                                    echo "
                                        <li><a href='#' class='activate' data-active='" . $dt->id_divisi . "' data-action='deactivate'><i class='fa fa-minus text-danger'></i> Non Active</a></li>
                                        <li><a href='#' class='delete' data-delete='" . $dt->id_divisi . "'><i class='fa fa-trash-o'></i> Hapus</a></li>
                                        ";
                                }else{
                                    echo "<li><a href='#' class='activate' data-active='" . $dt->id_divisi . "' data-action='activate'><i class='fa fa-check text-success'></i> Set Active</a></li>";
                                }
                                echo "    </ul>
				                          </div>
				                        </td>";
                            ...
                            <div class="tab-pane active" id="tab-edit">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="tanggal_bak">Nama Role</label>
                                        <div>
...
<script src="<?php echo base_url() ?>assets/apps/js/spk/master_role.js"></script>
